...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='tensorpack')
    ...
    setproctitle('train_tensorpack {}'.format(args.model_name))
    # read configs
    ...
    logger.debug(cfg.TRAIN.NUM_GPUS)
